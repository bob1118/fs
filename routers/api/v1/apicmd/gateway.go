...
// request: api/v1/gateway/:uuid/load
// response: json
//
//	{
//		code:{
...
// request: api/v1/gateway/:uuid/kill
// response: json
//
//	{
//		code:{
...
// request: api/v1/gateway/:uuid/reload
// response: json
//
//	{
//		code:{
...
// request: api/v1/gateway/:uuid/register
// response: json
//
//	{
//		code:{
...
// request: api/v1/gateway/:uuid/unregister
// response: json
//
//	{
//		code:{
